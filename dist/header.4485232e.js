...
var maxRadius = 40;
var circleArray = [];
var colorArray = ['#C9DAE', '#03F7EE', '#00B295', '#191516', '#AB2346'];
var mouse = {
  x: undefined,
  y: undefined
...
function Circle(x, y, dx, dy, radius) {
  ...
  this.color = colorArray[Math.floor(Math.random() * colorArray.length)]; //Draw circles
  ...
  this.update = function () {
    ...
    this.x += this.dx;
    this.y += this.dy; //Grow circles if mouse is close

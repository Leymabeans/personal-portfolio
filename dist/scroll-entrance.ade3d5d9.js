...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/vendor/scroll-entrance.js":[function(require,module,exports) {
(function () {
  //Create the object for the entrance plugin
  entrance = {}; //Set up defaults
  ...
  entrance.isElemInView = function (elem) {
    var rect = elem.getBoundingClientRect(); //Return true if any of the following conditions are met:

    return (// The top is in view: the top is more than 0 and less than the window height (the top of the element is in view)
      rect.top + entrance.heightOffset >= 0 && rect.top + entrance.heightOffset <= window.innerHeight || // The bottom is in view: bottom position is greater than 0 and greater than the window height
      rect.bottom + entrance.heightOffset >= 0 && rect.bottom + entrance.heightOffset <= window.innerHeight || // The top is above the viewport and the bottom is below the viewport
  ...
  entrance.setInitialStyles = function (elem) {
    ...
    elem.style.transition = "all " + entrance.duration / 1000 + "s ease"; // Add a delay is required
  ...
  entrance.init = function () {
    ...
    entrance.elements = document.querySelectorAll('[data-entrance]'); // Set up the initial styles on each element, and check if they schould be visible
  ...
  addEventListener('DOMContentLoaded', entrance.init, false); // Add event liseners for scroll events
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/vendor/scroll-entrance.js"], null)
//# sourceMappingURL=/scroll-entrance.ade3d5d9.js.map